        ...
        <div>
            ...
            {!isUserLoggedIn &&
                <nav className="flex justify-between items-center p-4 bg-gray-800 text-white relative">
                    ...
                    <h1 className="m-0 text-xl text-right">ShopSmartly</h1>
                    <div className="hidden lg:flex space-x-4">
                        <Link className="text-white text-lg p-2 rounded-lg transition duration-300 ease-in transform hover:bg-gray-600 hover:text-yellow-500 hover:scale-105" to="/login">Login</Link>
                        <Link className="text-white text-lg p-2 rounded-lg transition duration-300 ease-in transform hover:bg-gray-600 hover:text-yellow-500 hover:scale-105" to="/register">Register</Link>
                    </div>
                </nav>
            }
            <Outlet />
