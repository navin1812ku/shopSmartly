            ...
            <nav className="flex justify-between items-center p-4 bg-gray-800 text-white relative">
                <div className="relative cursor-pointer" onMouseEnter={toggleDropdown} onMouseLeave={toggleDropdown}>
                    ...
                    <div className={`absolute top-full left-0 flex-col bg-gray-800 list-none min-w-[200px] z-10 shadow-lg ${dropdownOpen ? "flex" : "hidden"}`} onMouseEnter={() => setDropdownOpen(true)} onMouseLeave={() => setDropdownOpen(false)}>
                        <Link className="block bg-gray-700 text-white p-2 mb-1 rounded transition duration-300 ease-in-out transform hover:bg-gray-600 hover:text-yellow-500 hover:scale-105 shadow-sm" to="/user/home/products">Search</Link>
                        <Link className="block bg-gray-700 text-white p-2 mb-1 rounded transition duration-300 ease-in-out transform hover:bg-gray-600 hover:text-yellow-500 hover:scale-105 shadow-sm" to="/user/cart">Cart</Link>
                        <Link className="block bg-gray-700 text-white p-2 mb-1 rounded transition duration-300 ease-in-out transform hover:bg-gray-600 hover:text-yellow-500 hover:scale-105 shadow-sm" to="/user/wishList">Wish List</Link>
